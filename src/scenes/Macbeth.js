class Macbeth extends Phaser.Scene {
    ...
    create() {
        ...
        this.witch1 = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'witch1').setOrigin(0, 1).setScale(0.2);
        this.witch2 = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'witch2').setOrigin(0, 1).setScale(0.2);
        this.witch3 = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'witch3').setOrigin(0, 1).setScale(0.3);
        this.witchAll = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'witchAll').setOrigin(0, 1).setScale(0.3);
